      ...
      <HStack gridGap="8">
        ...
        <Link href="https://gitcoin.co/grants/1709/ethereum-tools-and-educational-grant" variant="alpha">
          <HStack>
            ...
            <Tooltip label="Please help support the server costs, hosting Geth is not cheap 🖤 You can donate through Gitcon Grant, or through website sponsorships." textAlign="center" hasArrow placement="top">
              <Text>Donate</Text>
            </Tooltip>
          </HStack>
        </Link>
